...
async function create(conference_id, scheduleData) {
    ...
    const { title, description, start_time, end_time, location, speaker } =
        scheduleData;
...
async function findAll(conference_id, options = {}) {
    if (!conference_id) {
        throw new Error(
            'conference_id is required for querying schedule items',
        );
    }
...
async function update(id, conference_id, scheduleData) {
    if (!conference_id) {
        throw new Error(
            'conference_id is required for updating schedule items',
        );
    }
...
async function deleteById(id, conference_id) {
    if (!conference_id) {
        throw new Error(
            'conference_id is required for deleting schedule items',
        );
    }
