    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                `/api/v1/conferences/${conference.id}/abstracts`,
                {
                    method: 'POST',
                    headers: {
        ...
        return (
            <div style={styles.container}>
                <div style={styles.message}>
                    ...
                    <p>
                        Abstract submission is not currently available for this
                        conference.
                    </p>
        ...
        return (
            <div style={styles.container}>
                <div style={styles.message}>
                    ...
                    <Link
                        href={`/login?redirect=/c/${slug}/submit`}
                ...
                <div style={styles.content}>
                    {success ? (
                        <div style={styles.successMessage}>
                            ...
                            <p>
                                Your abstract has been submitted and is now
                                under review.
                            </p>
                            <Link
                                href={`/c/${slug}`}
                        ...
                        <form onSubmit={handleSubmit} style={styles.form}>
                            ...
                            <div style={styles.formGroup}>
                                ...
                                <input
                                    ...
                                    required
                                    maxLength={
                                        settings?.abstract_max_length || 300
                                    }
                            ...
                            <div style={styles.formGroup}>
                                <label style={styles.label}>
                                    ...
                                    <span style={styles.charCount}>
                                        ...
                                        {settings?.abstract_max_length || 5000}
                                    </span>
                                </label>
                                <textarea
                                    name="content"
