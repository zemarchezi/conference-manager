...
export default function ConferenceHome() {
    ...
    const fetchConferenceData = async () => {
        try {
            ...
            const settingsResponse = await fetch(
                `/api/v1/conferences/${conferenceData.id}/settings`,
            );
            ...
            const speakersResponse = await fetch(
                `/api/v1/conferences/${conferenceData.id}/speakers`,
            );
    ...
    const checkRegistrationStatus = async () => {
        try {
            const response = await fetch(
                `/api/v1/conferences/${conference.id}/registrations/my-registration`,
            );
            if (response.ok) {
    ...
    const handleRegister = async () => {
        ...
        try {
            const response = await fetch(
                `/api/v1/conferences/${conference.id}/registrations`,
                {
                    method: 'POST',
    ...
    const isOrganizer =
        currentUser && conference.organizer_id === currentUser.id;
    ...
    return (
        <>
            ...
            <div style={styles.container}>
                ...
                >
                    <div style={styles.headerContent}>
                        ...
                        <nav style={styles.nav}>
                            ...
                            <Link
                                href={`/c/${slug}/abstracts`}
                                style={styles.navLink}
                            >
                                Abstracts
                            </Link>
                            {settings?.venue_name && (
                                <a href="#venue" style={styles.navLink}>
                                    Venue
                                </a>
                            )}
                ...
                <section
                    id="contact"
                    style={{ ...styles.section, backgroundColor: '#f9fafb' }}
                >
                    <div style={styles.sectionContent}>
                ...
                <footer style={styles.footer}>
                    <p>
                        © {new Date().getFullYear()} {conference.title}.
                        Powered by Conference Manager.
                    </p>
                </footer>
            </div>
        ...
        <div style={isKeynote ? styles.keynoteSpeakerCard : styles.speakerCard}>
            ...
            <div style={styles.speakerInfo}>
                ...
                {speaker.organization && (
                    <p style={styles.speakerOrg}>{speaker.organization}</p>
                )}
