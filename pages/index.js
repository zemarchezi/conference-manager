    ...
    const fetchFeaturedConferences = async () => {
        try {
            const response = await fetch(
                '/api/v1/conferences?limit=6&status=active',
            );
            if (response.ok) {
            ...
            <section className="hero">
                ...
                <div className="hero-content">
                    <h1 className="hero-title">
                        Streamline Your{' '}
                        <span className="highlight">Academic Conferences</span>
                    </h1>
                    <p className="hero-subtitle">
                        A comprehensive platform for organizing conferences,
                        managing abstract submissions, and conducting peer
                        reviews with ease.
                    </p>
                ...
                <div className="container">
                    <div className="section-header">
                        ...
                        <p className="section-subtitle">
                            Powerful features to manage every aspect of your
                            academic conference
                        </p>
                    </div>
                    ...
                    <div className="features-grid">
                        <div className="feature-card">
                            ...
                            <p className="feature-description">
                                Create and manage multiple conferences with
                                customizable settings, deadlines, and scheduling
                                tools.
                            </p>
                        </div>
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-description">
                                Streamlined submission process with keyword
                                tagging, status tracking, and automated
                                notifications.
                            </p>
                        </div>
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-description">
                                Comprehensive peer review workflow with scoring,
                                recommendations, and reviewer assignments.
                            </p>
                        </div>
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-description">
                                ...
                                reviewers, authors, and attendees.
                            </p>
                        </div>
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-description">
                                Track submissions, reviews, and conference
                                metrics with detailed analytics and reports.
                            </p>
                        </div>
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-description">
                                Automated email notifications for submissions,
                                reviews, and important conference updates.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="conferences-section">
                <div className="container">
                    <div className="section-header">
                        ...
                        <p className="section-subtitle">
                            Discover upcoming academic conferences and submit
                            your research
                        </p>
                    </div>
                ...
                <div className="container">
                    <div className="cta-content">
                        ...
                        <p className="cta-description">
                            Join thousands of researchers and organizers using
                            Conference Manager
                        </p>
