...
import { createTestUser, createTestConference, cleanupTestData } from '../../../helpers/test-setup.js';
...
describe('GET /api/v1/conferences/[conference_id]/speakers', () => {
  ...
  it('should return all speakers for a conference', async () => {
    const response = await fetch(`http://localhost:3000/api/v1/conferences/${testConference.id}/speakers`);
