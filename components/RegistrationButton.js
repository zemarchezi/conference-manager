...
export default function RegistrationButton({ conferenceId, conferenceSlug }) {
  ...
  if (! isAuthenticated) {
    return (
      <a href={`/c/${conferenceSlug}/login? redirect=/c/${conferenceSlug}`} style={styles.button}>
        Login to Register
      </a>
    );
  }
    ...
    <div style={styles.modalOverlay} onClick={onClose}>
      <div style={styles.modal} onClick={(e) => e. stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.formGroup}>
            <label style={styles. label}>Dietary Requirements (Optional)</label>
            <input
              type="text"
          ...
          <div style={styles.formGroup}>
            <label style={styles.label}>Accessibility Needs (Optional)</label>
            <textarea
          ...
          <div style={styles.formGroup}>
            <label style={styles.label}>T-Shirt Size (Optional)</label>
            <select
