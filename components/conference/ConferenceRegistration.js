...
export default function ConferenceRegistration({ conferenceId, conferenceSlug, onRegister, isRegistered }) {
  ...
  return (
    <div className="conference-registration">
      ...
      <p className="intro">
        Join this conference and be part of an exciting academic event. Choose your role below.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        <div className="role-selection">
          ...
          <label className="role-option">
            ...
            <div className="role-card">
              <h3>Reviewer</h3>
              <p>Review submitted abstracts and provide feedback</p>
            </div>
          </label>
        </div>
