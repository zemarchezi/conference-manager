...
export default function ConferenceSubmissions({ conferenceId, conferenceSlug }) {
        ...
        {submissions.map((submission) => (
          <div key={submission.id} className="submission-card">
            ...
            <p className="submission-content">
              {submission.content ?  submission.content.substring(0, 200) : submission.abstract}
              {(submission.content?. length > 200 || submission.abstract?.length > 200) && '...'}
            </p>
